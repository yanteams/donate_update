...
$array_fields_search = [
    ...
    'customer_company' => $lang_module['customer_company'],
];
...
while ($row = $result->fetch()) {
    ...
    $arr_list_transaction[$row['id']] = [
        ...
        'customer_company' => $row['customer_company'] = ($row['customer_company']=='') ? $lang_module['customer_canhan'] : ($row['customer_company']), //

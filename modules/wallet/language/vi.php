...
$lang_module['no_account1'] = 'Tài khoản của bạn chưa được khởi tạo ví tiền. Hệ thống sẽ tự động chuyển đến trang Quyên góp vào ví trong giây lát';
$lang_module['back'] = 'Quay lại';
$lang_module['transaction_code'] = 'Mã giao dịch';
$lang_module['continue'] = 'Tiếp tục';

$lang_module['total_giaodich'] = 'Tổng giao dịch';
$lang_module['total_giaodich_doanhnghiep'] = 'Tổng giao dịch từ doanh nghiệp/tài trợ';
$lang_module['total_giaodich_canhan'] = 'Tổng giao dịch từ cá nhân';
...
$lang_module['customer_anonymous'] = 'Ẩn danh';
$lang_module['customer_anonymous_1'] = 'Ẩn danh';
$lang_module['customer_anonymous_0'] = 'Không ẩn danh';
...
$lang_module['note_pay'] = 'Quyên góp vào tài khoản qua';
$lang_module['note_pay_gate'] = 'Quyên góp vào tài khoản qua cổng %s';
$lang_module['error_captcha'] = 'Nhập mã bảo vệ bạn nhập không đúng';
$lang_module['error_money_recharge'] = 'Số tiền quyên góp phải lớn hơn 0';
$lang_module['error_money_recharge1'] = 'Số tiền quyên góp phải lớn hơn hoặc bằng %s';

$lang_module['transaction_info'] = 'Quyên góp vào tài khoản mã số %1$s tại %2$s';

$lang_module['payment_complete'] = 'Bạn đã Quyên góp thành công! ';
$lang_module['payment_erorr'] = 'Quá trình thanh toán có lỗi do một lý do nào đó';
$lang_module['payment_login'] = 'Để Quyên góp vào tài khoản bạn cần đăng nhập thành viên';
...
$lang_module['datetransaction'] = 'Thời gian';
...
$lang_module['payment_gamebank_ok'] = 'Quyên góp từ hệ thống Gamebank bằng mã số thẻ cào %s: %s';
...
$lang_module['loaithekhongdung'] = 'Lỗi: Loại thẻ không đúng. Thẻ nạp này tạm thời bị khóa. Vui lòng thử lại sau';
$lang_module['hethongdangbaotri'] = 'Lỗi: Hệ thống đang bảo trị. Vui lòng thử lại sau';
$lang_module['naptienthanhcong'] = 'Quyên góp thành công. Số tiền được quyên góp là %s VND. <br />Hệ thống sẽ tự động chuyển trang trong 5s';

$lang_module['smsNap'] = 'Nhắn tin SMS';
$lang_module['titleSmsNap'] = 'Nhắn tin SMS Quyên góp vào tài khoản';
$lang_module['sms'] = '<span style="font-weight:bold;font-size:14px;">Để Quyên góp vào tài khoản</span> ! Soạn tin theo mẫu : <span style="font-weight:bold; color:red">%s %s</span> trong đó : <span style="font-weight:bold; color:red">%s</span> là Từ khóa của chương trình, <span style="font-weight:bold; color:red">%s</span> là email của bạn rồi gửi đến số <span style="font-weight:bold; color:red">%s</span>';
...
$lang_module['pay_save_error_body'] = 'Quyên góp thất bại';
$lang_module['pay_save_ok_title'] = 'Quyên góp thành công';
$lang_module['pay_save_ok_body'] = 'Chúc mừng bạn đã Quyên góp thành công!';
$lang_module['pay_save_ok_wait'] = 'Quyên góp vào tài khoản thành công, số tiền sẽ được cập nhật vào tài khoản sau ít phút. Hãy liên hệ với quản trị site nếu số tiền không được cập nhật sau quá 5 phút';
$lang_module['pay_error_completeport'] = 'Quyên góp thất bại. Cổng thanh toán không có chức năng xử lý kết quả thanh toán, vui lòng liên hệ với quản trị site để được hỗ trợ';
$lang_module['pay_error_payport'] = 'Quyên góp thất bại. Cổng thanh toán không tồn tại';
$lang_module['pay_error_checkhash'] = 'Quyên góp thất bại. Dữ liệu trả về không đúng chuẩn, hệ thống từ chối thanh toán';
...
$lang_module['vnpt_title'] = 'Quyên góp qua thẻ cào';
...
$lang_module['payment_vnpt_ok'] = 'Quyên góp từ hệ thống VNPT EBAY bằng mã số thẻ cào %s: %s';
...
$lang_module['minimum_amount'] = 'Số tiền quyên góp tối thiểu phải là: ';

$lang_module['select_pay'] = 'Chọn hình thức quyên góp: ';
...
$lang_module['historyexchange'] = 'Lịch sử quyên góp';

$lang_module['recharge_error_message'] = 'Cổng thanh toán này không hỗ trợ loại tiền nào, vui lòng liên hệ với quản trị site về vấn đề này';
...
$lang_module['paygate_wpay_notenought'] = 'Số dư tài khoản của bạn không đủ để thanh toán. Vui lòng Quyên góp vào tài khoản trước';

...
//Wallet name
define('NV_WALLET_MODULE', "donations");
...
class nukeviet_wallet
{
    ...
    public function __construct()
    {
        ...
        $lang_module = array();
        $lang_file = NV_ROOTDIR . "/modules/donations/language/" . NV_LANG_DATA . ".php";
        if (file_exists($lang_file)) {
            require_once $lang_file;
        } else {
            require_once NV_ROOTDIR . "/modules/donations/language/vi.php";
        }

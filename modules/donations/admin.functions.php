...
$allow_func = array('main', 'config', 'add_donate','view_donate','main_donate','edit_donate','cat','tags','addacount','transaction','viewtransaction','add_transaction','order-list','exchange'
,'historyexchange','ipn-logs','delrate','money','delmoney','acount','actpay','ajax','config_payment','config_sms','delrate','exchange','historyexchange','payport','permission','statistics','permission-groups');

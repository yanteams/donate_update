        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="w150">{LANG.customer_name}</th>
                    <th class="w150">{LANG.customer_company}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{CONTENT.customer_company}</td>
                    <td class="text-right"><strong class="text-success">{CONTENT.status}{CONTENT.money_net}&nbsp;{CONTENT.money_unit}</strong></td>

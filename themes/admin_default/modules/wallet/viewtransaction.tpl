    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td><strong class="text-success">{CONTENT.money_total} {CONTENT.money_unit}</strong></td>
            </tr>
            <tr>
                <td>{LANG.money_net}</td>
                <td><strong class="text-success">{CONTENT.money_net} {CONTENT.money_unit}</strong></td>
            </tr>
            <tr>
                <td>{LANG.money_fee}</td>
                <td><strong class="text-success">{CONTENT.money_discount} {CONTENT.money_unit}</strong></td>
            </tr>
            <tr>
                <td>{LANG.num_money_collection}</td>
                <td><strong class="text-success">{CONTENT.money_revenue} {CONTENT.money_unit}</strong></td>
            </tr>
            <tr>

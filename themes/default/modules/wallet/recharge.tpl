    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-13">
                    <input class="form-control" type="text" name="customer_name" value=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-8">
            ...
            <div class="form-group">
                ...
                <div class="col-md-13">
                    <input class="form-control" type="text" name="customer_phone" value=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-8">
                ...
                <div class="col-md-13">
                    <input class="form-control" type="text" name="customer_address" value=""/>
                </div>
            </div>
            
            <div class="form-group">
                <label class="control-label col-md-8">
                    {LANG.customer_anonymous}:
                </label>
                <div class="col-md-13">
                    <select name="customer_anonymous" class="form-control">
                    <option value="1">{LANG.customer_anonymous_1}</option>
                    <option value="0">{LANG.customer_anonymous_0}</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-13">
                    <input class="form-control" type="text" name="customer_company" placeholder="(optional)" value=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-8">
